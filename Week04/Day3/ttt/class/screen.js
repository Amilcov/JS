...
//Adriana test:
// console.log('1 start : - printCommands');
// Screen.printCommands();
// Screen.addCommand('h', 'hello welcome', () => console.log('this is acction from h key press '))
// console.log('1 end : - printCommands');

// console.log('2 start: - initialize');
// Screen.initialize(5,5);
// console.log('2 end: - initialize');

// console.log('3 start: - setGridLines');
// Screen.setGridlines(true);
// console.log('3 end: - setGridLines');


// console.log('4 start: - setGrid');
// Screen.setGrid(2, 3, 'x');
// Screen.render();
// console.log('4 end: - setGrid');
